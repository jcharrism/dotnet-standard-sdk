...
namespace IBM.WatsonDeveloperCloud.CompareComply.v1.Model
{
    ...
    /// </summary>
    public class NLPReturnDocStructure : BaseModel
    {
        /// <summary>
        ...
        public List<SectionTitleObject> SectionTitles { get; set; }
        /// <summary>
        ...
        public List<LeadingSentenceObject> LeadingSentences { get; set; }
    }
