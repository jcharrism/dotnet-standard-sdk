...
namespace IBM.WatsonDeveloperCloud.CompareComply.v1.Model
{
    ...
    /// current table.
    /// </summary>
    public class RowHeadersArray : BaseModel
    {
        /// <summary>
        ...
        /// <summary>
        /// The location of the row header cell in the current table as defined by its `begin` and `end` offsets,
        ...
        /// otherwise, the same value as `cell_text`.
        /// </summary>
