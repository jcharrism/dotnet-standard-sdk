...
{
    /// <summary>
    /// A JSON object detailing the feedback to be added to an element in the document.
    /// </summary>
    public class FeedbackInput : BaseModel
    {
        ...
        /// <summary>
        /// An object defining the feedback.
        /// </summary>
        [JsonProperty("feedback_data", NullValueHandling = NullValueHandling.Ignore)]
        public List<FeedbackDataInputObject> FeedbackData { get; set; }
    }
