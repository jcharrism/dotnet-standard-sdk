...
{
    [TestClass]
    public class LanguageTranslatorServiceITCF
    {
        ...
        [TestMethod]
        public void GetIdentifiableLanguages_Sucess_CF()
        {
            _service =
                new LanguageTranslatorService(_username, _password, _versionDate);
        ...
        [TestMethod]
        public void Identify_Sucess_CF()
        {
            _service =
                new LanguageTranslatorService(_username, _password, _versionDate);
            _service.SetEndpoint(_endpoint);
        ...
        [TestMethod]
        public void Translate_Sucess_CF()
        {
            _service =
                new LanguageTranslatorService(_username, _password, _versionDate);
            _service.SetEndpoint(_endpoint);
        ...
        [TestMethod]
        public void LisListModels_Sucess_CF()
        {
            _service =
                new LanguageTranslatorService(_username, _password, _versionDate);
            _service.SetEndpoint(_endpoint);
        ...
        [TestMethod]
        public void GetModelDetails_Success_CF()
        {
            _service =
                new LanguageTranslatorService(_username, _password, _versionDate);
            _service.SetEndpoint(_endpoint);
